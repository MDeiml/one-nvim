...
local highlight_groups = {
    ...
    -------------------------------------------------------------
     ...
     Title        = { fg = hue_6_2, bg = none, style = 'bold'},
...
-----------------------------
     ...
     TSSymbol             = { fg = hue_1 },
     TSTag                = 'htmlTagName',
     TSTagAttribute       = 'htmlArg',
     TSTagDelimiter       = 'htmlTag',
     TSText               = {},
     TSTextReference      = { fg = hue_3 },
     TSTitle              = 'Title',
     TSTODO               = 'SpecialComment',
     TSType               = 'Type',
     TSTypeBuiltin        = 'Type',
